...
export function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group position={[-9.41, -10.34, 3.781]} rotation={[-Math.PI / 2, 0, 0]} scale={0.002}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group position={[-392.543, -171.041, -646.595]} rotation={[-Math.PI / 2, 0, -Math.PI]} scale={[103.06, 115.468, 115.468]}>
            ...
            <mesh geometry={nodes.Cylinder014_tire_0.geometry} material={materials.tire} rotation={[-0.373, 1.278, 0.512]} scale={[0.01, 0.01, 0.014]} />
          </group>
          <group rotation={[-Math.PI / 2, 0, 0]} scale={100}>
            <group position={[3.334, -3.889, 1.265]} rotation={[-0.511, -0.11, 0.391]}>
            ...
            <group position={[3.925, 6.466, -1.71]} scale={[1.031, 1.155, 1.155]}>
            ...
            <group position={[-0.662, -3.057, 0.906]} rotation={[-Math.PI / 2, 0, 0]}>
            ...
            <group position={[3.888, -7.662, -1.71]} rotation={[0, 0, -0.239]} scale={[1.031, 1.155, 1.155]}>
            ...
            <mesh geometry={nodes.Plane056_license_0.geometry} material={materials.license} position={[0, 11.434, -0.954]} rotation={[-1.377, 0, -Math.PI]} scale={0.962} />
            ...
            <mesh geometry={nodes.Cube001_black_paint_0.geometry} material={materials.black_paint} position={[-1.129, -10.895, -0.163]} rotation={[Math.PI / 2, 0, Math.PI]} />
            ...
            <mesh geometry={nodes.Plane040_license_0.geometry} material={materials.license} position={[1.332, -11.729, -1.245]} rotation={[1.757, 0.031, -0.008]} scale={0.871} />
          ...
          <group position={[-389.323, -172.791, 728.157]} rotation={[-Math.PI / 2, -0.026, 2.83]} scale={[103.06, 115.468, 115.468]}>
            ...
            <mesh geometry={nodes.Cylinder008_tire_0.geometry} material={materials.tire} rotation={[-0.373, 1.278, 0.512]} scale={[0.01, 0.01, 0.014]} />
          </group>
          <group position={[-438.679, 70.135, -1050.148]} rotation={[-1.626, -1.394, -1.625]} scale={126.708}>
          ...
          <group position={[440.04, 70.219, -972.605]} rotation={[-1.707, 1.332, 1.705]} scale={126.708}>
          ...
          <mesh geometry={nodes.Sphere001_headlights_0.geometry} material={materials.headlights} rotation={[Math.PI, 0, 0]} scale={[56.676, 56.676, 38.196]} />
          <mesh geometry={nodes.Plane035__0.geometry} material={materials['Plane.035__0']} position={[0, -341.508, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={[685.922, 1371.843, 685.922]} />
          <mesh geometry={nodes.Cylinder010_tire_0.geometry} material={materials.tire} position={[392.543, -171.041, -646.595]} rotation={[-1.942, 1.278, 0.499]} scale={[1.195, 1.195, 1.404]} />
          <mesh geometry={nodes.Cylinder009_tire_0.geometry} material={materials.tire} position={[388.814, -171.041, 766.162]} rotation={[-1.137, 1.27, -0.339]} scale={[1.195, 1.195, 1.404]} />
          <mesh geometry={nodes.Plane033_stickers_0.geometry} material={materials.stickers} position={[-129.723, 37.745, -1157.984]} rotation={[-3.093, -0.022, -3.14]} scale={75.045} />
          <mesh geometry={nodes.Plane032_stickers_0.geometry} material={materials.stickers} position={[369.478, -126.175, -1112.152]} rotation={[2.772, 0.117, -1.23]} scale={129.135} />
          <mesh geometry={nodes.Plane029_stickers_0.geometry} material={materials.stickers} position={[157.01, -15.816, 1116.22]} scale={73.118} />
        </group>
      </group>
    </group>
  )
